    ...
    return (
      <footer className="footerContainer">
        ...
        <div className="socials">
          <a href="https://www.facebook.com/cuklove" target="_blank" rel="noreferrer">
            <img src="/images/facebook.png" alt="Facebook" className="facebook" />
          </a>
          <a href="https://www.instagram.com/lovecuk" target="_blank" rel="noreferrer"> 
            <img
          ...
          <a href="https://blog.naver.com/ilovecuk" target="_blank" rel="noreferrer"> 
            <img src="/images/blog.png" alt="blog" className="blog" />
          </a>
          <a href="https://www.youtube.com/channel/UCXCTZNby7FR4Ijb2_X8X_mA" target="_blank" rel="noreferrer"> 
